...
if __name__ == "__main__":
    ...
    print(f"Nome: {persona1._Persona__first_name}, Cognome: {persona1._Persona__last_name}, Età: {persona1._Persona__age}")

    persona2 = Persona("Giulia", 123)
    print(f"Nome: {persona2._Persona__first_name}, Cognome: {persona2._Persona__last_name}, Età: {persona2._Persona__age}")
    
    persona2.setName("Luca")
    print(f"Nome modificato: {persona2._Persona__first_name}")
