...
La temperatura deve essere convertita e visualizzata in gradi Celsius con un numero in
virgola mobile con una precisione di un decimo di grado.
...
gradiFahrenheit:int =  108

gradiCelsius = 5 * (gradiFahrenheit-32) /9

print(round(gradiCelsius,1))